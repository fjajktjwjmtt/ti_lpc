...
ifneq ($(OS),Windows_NT)			#linux?
	...
	CFLAGS=-g -Wfatal-errors -Wfatal-errors -fpermissive -Wno-narrowing -Dbuild_date="\"`date +%Y-%b-%d`\"" #-Dbuild_date="\"2016-Mar-23\"" `pkg-config --cflags libpulse-simple` `pkg-config --cflags rtaudio`
